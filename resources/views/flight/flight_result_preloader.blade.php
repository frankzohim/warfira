...
<div class="fulloading result-pre-loader-wrapper">
    ...
    <div class="centerload cityload">
        <div class="load_links" style="position: absolute;top: 0;right: 0;z-index: 9999;font-size:14px;font-weight:300">
            ...
            <a href="<?php echo env("APP_URL"); ?>"><i class="fa fa-close"></i></a>
        </div>
        ...
        <div class="relativetop">
            <div class="tmxloader hide"><img class="loadvgif" src="<?php echo asset('images/tm_loader(1).gif'); ?>" alt="Logo" />
            </div>
            <div class="paraload">@lang('b2c/header.prelad text')
            </div>
            ...
            <div class="sckintload <?=$trip_type_loader?>">
                ...
                <div class="clearfix"></div>
                <div class="nigthcunt">
                    <?=ucfirst($trip_details['trip_type'])?> <?="Trip";?>
