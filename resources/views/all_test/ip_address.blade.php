    ...
    <div class="card">
        <div class="card-body">
            @if($currentUserInfo)
                ...
                <h4>Language: {{ \App\Http\Middleware\AppMiddlewares\DefaultWebMiddleware::getCountryLanguage($currentUserInfo->countryCode) }}</h4>
                <h4>Language: {{ \App\Http\Middleware\AppMiddlewares\DefaultWebMiddleware::getCountryCurrency($currentUserInfo->countryName) }}</h4>
            @endif
        </div>
    </div>
</div>
