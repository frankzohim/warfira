$(document).ready(function() {
    ...
    $('#hotel_search input[name="child[]"]').on('change', function() {
     ...
     function total_pax_summary() {
        ...
        var adults  =  $('#adults_lang').val();
        var adult  =  $('#adult_lang').val();
        var rooms  =  $('#rooms_lang').val();
        var room  =  $('#room_lang').val();
        var child  =  $('#child_lang').val();
        var children  =  $('#children_lang').val();
        var total_adults = 0;
