...
function getShowLinkText(currentText) {
    var newText = '';
    var show_more = $(".show_more_lang").val();
    var show_less = $(".show_less_lang").val();
...
function getShowLinkRooms(currentText) {
    var newText = '';
     var show_more_room = $(".show_room_more_lang").val();
    var show_less_room = $(".show_room_less_lang").val();
    // if (currentText.toUpperCase() === "SHOW MORE ROOMS +") {
    //     newText = "Show Less Rooms -";
    // } else {
    //     newText = "Show More Rooms +";
    // }
     if (currentText === show_more_room) {
        newText = show_less_room;
    } else {
        newText = show_more_room;
    }
    return newText;
}
});
